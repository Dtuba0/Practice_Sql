...
--NOT: UNIQUE null kabul eder. Birden fazla da kabul eder cunku null bir deger degildir.
--Karsilastirma yapmaz
...
--INSERT INTO worker VALUES('10004', 'Donatello', 5000, '2018-04-14');--HATA isim unıque cunku
    INSERT INTO worker VALUES('10005', 'Michelangelo', 5000, '2018-04-14'); --başarılı
--INSERT INTO worker VALUES('10006', 'Leonardo', null, '2019-04-12'); --HATA maası null olamaz
--INSERT INTO worker VALUES('10007', 'Raphael', '', '2018-04-14');--HATA maasta hıclık gonderılmıs
    INSERT INTO worker VALUES('', 'April', 2000, '2018-04-14');--basarili, PK bos string kabul eder ama kullanilmasi onerilmez
--INSERT INTO worker VALUES('', 'Ms.April', 2000, '2018-04-14');--HATA PK unique dır
--INSERT INTO worker VALUES('10002', 'Splinter', 12000, '2018-04-14'); --HATA 10002 daha once kullanıldı ABORT
--INSERT INTO worker VALUES(null, 'Fred', 12000, '2018-04-14'); -- HATA PK null kabul etmez
    INSERT INTO worker VALUES('10008', 'Barnie', 10000, '2018-04-14'); -- basarılı
    INSERT INTO worker VALUES('10009', 'Wilma', 11000, '2018-04-14');-- basarılı
    INSERT INTO worker VALUES('10010', 'Betty' ,12000, '2018-04-14');-- basarılı

--child --FK
    INSERT INTO address VALUES('10003','Ninja Sok', '40.Cad.', 'IST');-- basarılı
    INSERT INTO address VALUES('10003','Kaya Sok', '50.Cad.', 'Ankara');-- basarılı
    INSERT INTO address VALUES('10002','Taş Sok', '30.Cad.', 'Konya');-- basarılı
    INSERT INTO address VALUES('10012','Taş Sok', '30.Cad.', 'Konya');--HATA PK de 10012 yok
    INSERT INTO address VALUES(NULL,'Taş Sok', '23.Cad.', 'Konya'); -- basarılı
    INSERT INTO address VALUES(NULL,'Taş Sok', '23.Cad.', 'Konya');-- basarılı
...
/*
------------------------------------------------------------
        14- WHERE ifadesi, belirli koşulları karşılayan kayıtları seçmek için kullanılır. Bir SELECT,
         UPDATE ya da DELETE sorgusunda, hangi satırların işleme dahil edileceğini belirtmek için WHERE koşulu eklenir.*/
 /*
...
*/
    /*
    DELETE FROM worker WHERE id = '10002';--şimdi başarılı
...
--------------------
    ...
    DROP TABLE students CASCADE ; --cascade sadece baglantıyı koparır

    DROP TABLE IF EXISTS students18;
--boyle bir tablo yoksa uygulama durmasin varsa silsin demektir(IF EXISTS)
--NOTICE:  table "students18" does not exist, skipping yazısını verdı zaten
